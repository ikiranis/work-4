...
{
/* Εδώ γράψτε κώδικα C που θα υλοποιεί τη συνάρτηση show για την εμφάνιση των στοιχείων της στοίβας */
/* Η συνάρτηση είναι ΑΝΑΔΡΟΜΙΚΗ και εμφανίζει τα στοιχεία της στοίβας από την κορυφή προς τα κάτω. */
}
...
/* Εδώ γράψτε κώδικα για την εισαγωγή στη στοίβα των βαθμών των φοιτητών */
/* Χρησιμοποιήστε Αμυντικό Προγραμματισμό ώστε οι βαθμοί που θα εισάγονται να */
/* βρίσκονται στο κλειστό διάστημα [1,10]. Υποθέτουμε ότι όλοι οι βαθμοί είναι ακέραιοι */
/* Κάθε ακέραιος βαθμός που θα ανήκει στο [1,10] θα εισάγεται στην στοίβα */

    printf("Ο Βαθμός που δώσατε έχει καταχωρηθεί. \n ");
    printf("\n");
/* Εδώ γράψτε κώδικα για την εισαγωγή σπό τον χρήστη 1 ώστε να συνεχίσει την εισαγωγή ή 0 για να σταματήσει */
/* Χρησιμοποιήστε Αμυντικό Προγραμματισμό ώστε να μπορεί να εισαχθεί μόνο 1 για συνέχεια και 0 για τέλος της εισαγωγής */
